...
5. <code class="language-plaintext highlighter-rouge">Renewable and Sustainable Energy Reviews</code> &nbsp;&nbsp;&nbsp;&nbsp;Zhang, R., Xu, X., **Liu, K.**, Kong, L., Wang, W., & Wortmann, T. [**Airflow modelling for building design: A designers' review**](https://doi.org/10.1016/j.rser.2024.114380), 2024, 197, 114380.
